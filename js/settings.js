                    ...
                    <div class="bg-gradient-to-b from-slate-950 via-slate-900 to-slate-800 rounded-2xl p-4 shadow-2xl sticky top-14 border border-white/10 ring-1 ring-white/10 backdrop-blur-sm h-full overflow-hidden">
                        ...
                        <div class="rounded-xl border border-white/10 bg-white/5 p-2 h-full overflow-hidden shadow-inner">
                            <div class="space-y-2" id="settings-sidebar">
                                <button class="settings-nav-btn w-full text-right px-3 py-2 rounded-xl border border-white/10 bg-white/5 hover:bg-white/10 font-semibold text-white shadow-sm transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-blue-400/40" data-section="general">عام</button>
                                <button class="settings-nav-btn w-full text-right px-3 py-2 rounded-xl border border-white/10 bg-white/5 hover:bg-white/10 font-semibold text-white shadow-sm transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-blue-400/40" data-section="backup">إدارة البيانات</button>
                                <button id="settings-users-nav" class="settings-nav-btn w-full text-right px-3 py-2 rounded-xl border border-white/10 bg-white/5 hover:bg-white/10 font-semibold text-white shadow-sm transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-blue-400/40 hidden" data-section="users">المستخدمين</button>
                                <button class="settings-nav-btn w-full text-right px-3 py-2 rounded-xl border border-white/10 bg-white/5 hover:bg-white/10 font-semibold text-white shadow-sm transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-blue-400/40" data-section="updates">التحديثات</button>
                                <button class="settings-nav-btn w-full text-right px-3 py-2 rounded-xl border border-white/10 bg-white/5 hover:bg-white/10 font-semibold text-white shadow-sm transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-blue-400/40" data-section="license">الترخيص</button>
                            </div>
                        </div>
                    </div>
                </div>
